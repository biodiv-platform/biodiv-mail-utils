...
public class EnumModel {
	...
	public enum MAIL_TYPE {
		...
		COMMENT_POST("COMMENT_POST"), POST_TO_GROUP("POST_TO_GROUP"), FACT_ADDED("FACT_ADDED"),
		FACT_UPDATED("FACT_UPDATED"), TAG_UPDATED("TAG_UPDATED"), CUSTOM_FIELD_UPDATED("CUSTOM_FIELD_UPDATED"),
		...
		CCA_TEMPLATE_DELETED("CCA_DATA_DELETED"),OBSERVATION_ADDED("OBSERVATION_ADDED"), OBSERVATION_UPDATED("OBSERVATION_UPDATED"),
		...
		DOCUMENT_COMMENT_POST("DOCUMENT_COMMENT_POST"), 
		DOCUMENT_POST_TO_GROUP("DOCUMENT_POST_TO_GROUP"), DOCUMENT_ADDED("DOCUMENT_ADDED"),
