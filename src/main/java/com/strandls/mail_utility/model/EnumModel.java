...
public class EnumModel {
	...
	public enum MAIL_TYPE {
		...
		CCA_DATA_PERMISSION_REQUEST("CCA_DATA_PERMISSION_REQUEST"), CCA_DATA_POST_TO_GROUP("CCA_DATA_POST_TO_GROUP"),
		PAGE_CREATE("PAGE_CREATE"), PAGE_UPDATE("PAGE_UPDATE"), PAGE_DELETED("PAGE_DELETED"),
		PAGE_COMMENT_POST("PAGE_COMMENT_POST"), PAGE_COMMENT_DELETE("PAGE_COMMENT_DELETE"),
		...
		DATATABLE_COMMENT_DELETE("DATATABLE_COMMENT_DELETE"), DATATABLE_POST_TO_GROUP("DATATABLE_POST_TO_GROUP"),
		ODK_USER_EMAIL("ODK_USER_EMAIL");
