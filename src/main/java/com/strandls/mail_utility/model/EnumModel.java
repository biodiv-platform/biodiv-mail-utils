...
public class EnumModel {
	...
	public enum MAIL_TYPE {
		...
		SPECIES_FIELD_UPDATED("SPECIES_FIELD_UPDATED"),
		SPECIES_FIELD_DELETED("SPECIES_FIELD_DELETED"),
		SPECIES_FIELD_ADDED("SPECIES_FIELD_ADDED"),
		SPECIES_POST_TO_GROUP("SPECIES_POST_TO_GROUP"),
		SPECIES_COMMON_NAME("SPECIES_COMMON_NAME"), SPECIES_SYNONYMS("SPECIES_SYNONYMS"),SPECIES_RESOURCE("SPECIES_RESOURCE"),
		...
		CCA_TEMPLATE_DELETED("CCA_TEMPLATE_DELETED"), CCA_DATA_COMMENT("CCA_DATA_COMMENT"),
		CCA_TEMPLATE_COMMENT("CCA_TEMPLATE_COMMENT"), CCA_DATA_PERMISSION("CCA_DATA_PERMISSION"), CCA_DATA_PERMISSION_REQUEST("CCA_DATA_PERMISSION_REQUEST"),
