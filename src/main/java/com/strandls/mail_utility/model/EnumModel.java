...
public class EnumModel {
	...
	public enum OBJECT_TYPE{
		INVALID("INVALID"),OBSERVATION("observation"),CCA("cca"),DOCUMENT("document") ,SPECIES("species"),DATATABLE("datatable");
		private String action;
	...
	public enum MAIL_TYPE {
		...
		CCA_DATA_PERMISSION("CCA_DATA_PERMISSION"),CCA_DATA_PERMISSION_REMOVED("CCA_DATA_PERMISSION_REMOVED"), CCA_DATA_FOLLOW("CCA_DATA_FOLLOW"),
