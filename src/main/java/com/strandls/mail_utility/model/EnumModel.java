...
public class EnumModel {
	...
	public enum MAIL_TYPE {
		...
		DOCUMENT_COMMENT_POST("DOCUMENT_COMMENT_POST"), DOCUMENT_COMMENT_DELETE("DOCUMENT_COMMENT_DELETE"),
		COMMENT_POST("COMMENT_POST"), DELETED_COMMENT("DELETED_COMMENT"), POST_TO_GROUP("POST_TO_GROUP"),
		...
		SPECIES_UPDATED("SPECIES_UPDATED"), SPECIES_COMMENT_POST("SPECIES_COMMENT_POST"),
		SPECIES_COMMENT_DELETE("SPECIES_COMMENT_DELETE"), SPECIES_FACT("SPECIES_FACT"),
		...
		CCA_DATA_PERMISSION("CCA_DATA_PERMISSION"), CCA_DATA_PERMISSION_REMOVED("CCA_DATA_PERMISSION_REMOVED"),
		CCA_DATA_FOLLOW("CCA_DATA_FOLLOW"), CCA_DATA_UNFOLLOW("CCA_DATA_UNFOLLOW"),
		CCA_DATA_PERMISSION_REQUEST("CCA_DATA_PERMISSION_REQUEST"),
		CCA_DATA_POST_TO_GROUP("CCA_DATA_POST_TO_GROUP"), PAGE_CREATE("PAGE_CREATE"), PAGE_UPDATE("PAGE_UPDATE"),
		PAGE_DELETED("PAGE_DELETED"), PAGE_COMMENT_POST("PAGE_COMMENT_POST"),
		PAGE_COMMENT_DELETE("PAGE_COMMENT_DELETE"), PERMISSION_GRANTED("PERMISSION_GRANTED"),
		DATATABLE_CREATED("DATATABLE_CREATED"), DATATABLE_DELETED("DATATABLE_DELETED"),
		DATATABLE_COMMENT_POST("DATATABLE_COMMENT_POST"), DATATABLE_COMMENT_DELETE("DATATABLE_COMMENT_DELETE"),
