...
public class EnumModel {
	...
	public enum MAIL_TYPE {
		...
		DOCUMENT_POST_TO_GROUP("DOCUMENT_POST_TO_GROUP"),
		FACT_ADDED("FACT_ADDED"), FACT_UPDATED("FACT_UPDATED"), TAG_UPDATED("TAG_UPDATED"),
		CUSTOM_FIELD_UPDATED("CUSTOM_FIELD_UPDATED"), OBSERVATION_ADDED("OBSERVATION_ADDED"),
		OBSERVATION_UPDATED("OBSERVATION_UPDATED"), OBSERVATION_LOCKED("OBSERVATION_LOCKED"),
		OBSERVATION_UNLOCKED("OBSERVATION_UNLOCKED"), OBSERVATION_FLAGGED("OBSERVATION_FLAGGED"),
		OBSERVATION_DELETED("OBSERVATION_DELETED"), RATED_MEDIA_RESOURCE("RATED_MEDIA_RESOURCE"),
		AGREED_SPECIES("AGREED_SPECIES"), REMOVED_SPECIES("REMOVED_SPECIES"), FEATURED_POST("FEATURED_POST"),
		FEATURED_POST_IBP("FEATURED_POST_IBP"), SUGGEST_MAIL("SUGGEST_MAIL"), SEND_INVITE("SEND_INVITE"),
		SEND_REQUEST("SEND_REQUEST"), MY_UPLOADS_DELETE_MAIL("MY_UPLOADS_DELETE_MAIL"),
		PERMISSION_REQUEST("PERMISSION_REQUEST"), DOCUMENT_ADDED("DOCUMENT_ADDED"),
		DOCUMENT_DELETED("DOCUMENT_DELETED"), DOCUMENT_UPDATED("DOCUMENT_UPDATED"),
		CCA_DATA_ADDED("CCA_DATA_ADDED"), CCA_DATA_UPDATED("CCA_DATA_UPDATED"), CCA_DATA_DELETED("CCA_DATA_DELETED"),
		CCA_TEMPLATE_ADDED("CCA_TEMPLATE_ADDED"), CCA_TEMPLATE_UPDATED("CCA_TEMPLATE_UPDATED"),
		CCA_TEMPLATE_DELETED("CCA_DATA_DELETED"),DOCUMENT_FLAGGED("DOCUMENT_FLAGGED"), PERMISSION_GRANTED("PERMISSION_GRANTED");
