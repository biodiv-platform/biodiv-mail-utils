...
public class EnumModel {
	...
	public enum MAIL_TYPE {
		...
		CCA_DATA_PERMISSION_REQUEST("CCA_DATA_PERMISSION_REQUEST"), PAGE_CREATE("PAGE_CREATE"),
		...
		DATATABLE_COMMENT_POST("DATATABLE_COMMENT_POST"), DATATABLE_POST_TO_GROUP("DATATABLE_POST_TO_GROUP"),
